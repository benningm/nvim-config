...
_G.packer_plugins = {
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/home/benning/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  neorg = {
    ...
    loaded = true,
    path = "/home/benning/.local/share/nvim/site/pack/packer/start/neorg",
  ...
  ["nvim-treesitter"] = {
    ...
    loaded = true,
    only_config = true,
    path = "/home/benning/.local/share/nvim/site/pack/packer/start/nvim-treesitter",
